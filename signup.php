...
<body>
  <div class="container rms-design">
      <div class="row content-area custom-width">
				   ...
				   <?php
					...
					<form method="POST" action="signupValid.php" id="signupValid" >
                      <div class="form-group input-height">
                         ...
                         <input type="email" name="email_id" class="form-control" id="exampleInputEmail1" placeholder="name@yourname.com" required>
                      </div>
                      <div class="form-group input-height">
                       ...
                       <div class="form-group">
                        <button type="submit" class="btn btn-acc d-block w-100 btn-lg btn-create">Create New Account</button>
                      </div>
                   </form>
                </div>
       ...
       <div class="col-md-12 signin text-center"><p>I'm already a member.<a href="login.php">Sign In</a></p></div>
    </div>    
  </div>
<style>
.vendor-logo>img{
